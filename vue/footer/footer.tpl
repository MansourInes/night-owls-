...
<!--        
        <div class="social-icons">
            ...
            <a href="https://www.instagram.com/"> <img src="./vue/img/instaLogo.png"  alt="logo"> </i> </a>
            <a href="https://www.linkedin.com/feed/"> <img src="./vue/img/linkedinLogo.png"  alt="logo"> </i> </a>
            <a href="https://twitter.com/?lang=fr"> <img src="./vue/img/xLogo.png"  alt="logo"> </i> </a>
            Ajoutez d'autres liens sociaux ici avec les icônes correspondantes -->
        <!-- </div> -->

    </div>
        
    <div class="footer-bottom">
        <p>&copy; Night Owls. Tous droits réservés. | Site web créé par le groupe InnovTech</p>
    </div>
</footer>
</body>
</html>
